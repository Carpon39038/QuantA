...
按新的 source strategy 推进实现：先补 `Tushare Pro 5000` provider，再把公告/公开信息链接到 `巨潮资讯` 和交易所官方源，最后保留 `AKShare/BaoStock` 作为 shadow validation 和 gap-fill。
