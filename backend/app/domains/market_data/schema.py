...
TABLE_DEFINITIONS: tuple[TableDefinition, ...] = (
    ...
    TableDefinition(
        group="Market Data",
        name="benchmark_index_daily_raw",
        description="canonical 指数与回测基准原始日线事实表，按 raw_snapshot_id 保留外部数据源输入。",
        columns=(
            ColumnDefinition("raw_snapshot_id", "VARCHAR", "原始快照标识"),
            ColumnDefinition("index_symbol", "VARCHAR", "指数代码"),
            ColumnDefinition("display_name", "VARCHAR", "指数名称", allow_null=True),
            ColumnDefinition("trade_date", "DATE", "交易日"),
            ColumnDefinition("open_raw", "DOUBLE", "原始开盘点位", allow_null=True),
            ColumnDefinition("high_raw", "DOUBLE", "原始最高点位", allow_null=True),
            ColumnDefinition("low_raw", "DOUBLE", "原始最低点位", allow_null=True),
            ColumnDefinition("close_raw", "DOUBLE", "原始收盘点位", allow_null=True),
            ColumnDefinition("pre_close_raw", "DOUBLE", "原始前收点位", allow_null=True),
            ColumnDefinition("change_pct", "DOUBLE", "涨跌幅百分比", allow_null=True),
            ColumnDefinition("volume", "DOUBLE", "成交量", allow_null=True),
            ColumnDefinition("amount", "DOUBLE", "成交额", allow_null=True),
            ColumnDefinition("source", "VARCHAR", "数据来源"),
            ColumnDefinition("raw_payload_json", "VARCHAR", "上游原始行 JSON"),
            ColumnDefinition("updated_at", "TIMESTAMP", "写入更新时间"),
        ),
        primary_key=("raw_snapshot_id", "index_symbol", "trade_date"),
    ),
    TableDefinition(
        group="Market Data",
        name="financial_fina_indicator_fact",
        description="Tushare fina_indicator_vip 原始财务指标事实表，保留 report period 与 raw_snapshot_id 绑定。",
        columns=(
            ColumnDefinition("raw_snapshot_id", "VARCHAR", "原始快照标识"),
            ColumnDefinition("symbol", "VARCHAR", "证券代码"),
            ColumnDefinition("report_period", "DATE", "财报报告期"),
            ColumnDefinition("ann_date", "DATE", "公告日期", allow_null=True),
            ColumnDefinition("f_ann_date", "DATE", "实际公告日期", allow_null=True),
            ColumnDefinition("roe_dt", "DOUBLE", "扣非 ROE", allow_null=True),
            ColumnDefinition("grossprofit_margin", "DOUBLE", "毛利率", allow_null=True),
            ColumnDefinition("debt_to_assets", "DOUBLE", "资产负债率", allow_null=True),
            ColumnDefinition("ocf_to_profit", "DOUBLE", "经营现金流与利润比", allow_null=True),
            ColumnDefinition("source", "VARCHAR", "数据来源"),
            ColumnDefinition("raw_payload_json", "VARCHAR", "上游原始行 JSON"),
            ColumnDefinition("updated_at", "TIMESTAMP", "写入更新时间"),
        ),
        primary_key=("raw_snapshot_id", "symbol", "report_period"),
    ),
    TableDefinition(
        group="Market Data",
        name="financial_income_fact",
        description="Tushare income_vip 原始利润表事实表，供后续财务追溯与重算使用。",
        columns=(
            ColumnDefinition("raw_snapshot_id", "VARCHAR", "原始快照标识"),
            ColumnDefinition("symbol", "VARCHAR", "证券代码"),
            ColumnDefinition("report_period", "DATE", "财报报告期"),
            ColumnDefinition("ann_date", "DATE", "公告日期", allow_null=True),
            ColumnDefinition("f_ann_date", "DATE", "实际公告日期", allow_null=True),
            ColumnDefinition("total_revenue", "DOUBLE", "营业总收入", allow_null=True),
            ColumnDefinition("revenue", "DOUBLE", "营业收入", allow_null=True),
            ColumnDefinition("operate_profit", "DOUBLE", "营业利润", allow_null=True),
            ColumnDefinition("total_profit", "DOUBLE", "利润总额", allow_null=True),
            ColumnDefinition("n_income_attr_p", "DOUBLE", "归母净利润", allow_null=True),
            ColumnDefinition("source", "VARCHAR", "数据来源"),
            ColumnDefinition("raw_payload_json", "VARCHAR", "上游原始行 JSON"),
            ColumnDefinition("updated_at", "TIMESTAMP", "写入更新时间"),
        ),
    ...
    TableDefinition(
        group="Market Data",
        name="financial_balancesheet_fact",
        description="Tushare balancesheet_vip 原始资产负债表事实表，供后续财务追溯与重算使用。",
        columns=(
            ColumnDefinition("raw_snapshot_id", "VARCHAR", "原始快照标识"),
            ColumnDefinition("symbol", "VARCHAR", "证券代码"),
            ColumnDefinition("report_period", "DATE", "财报报告期"),
    ...
    TableDefinition(
        group="Market Data",
        name="financial_cashflow_fact",
        description="Tushare cashflow_vip 原始现金流量表事实表，供后续财务追溯与重算使用。",
        columns=(
            ColumnDefinition("raw_snapshot_id", "VARCHAR", "原始快照标识"),
            ColumnDefinition("symbol", "VARCHAR", "证券代码"),
            ColumnDefinition("report_period", "DATE", "财报报告期"),
            ...
            ColumnDefinition("c_free_cashflow", "DOUBLE", "企业自由现金流", allow_null=True),
            ColumnDefinition("source", "VARCHAR", "数据来源"),
            ColumnDefinition("raw_payload_json", "VARCHAR", "上游原始行 JSON"),
            ColumnDefinition("updated_at", "TIMESTAMP", "写入更新时间"),
        ),
    ...
    TableDefinition(
        ...
        description="发布快照绑定的指数与回测基准日线序列，供回测曲线和市场参照读取。",
        columns=(
            ColumnDefinition("snapshot_id", "VARCHAR", "发布快照标识"),
            ColumnDefinition("index_symbol", "VARCHAR", "指数代码"),
            ColumnDefinition("display_name", "VARCHAR", "指数名称", allow_null=True),
            ColumnDefinition("trade_date", "DATE", "交易日"),
            ColumnDefinition("price_basis", "VARCHAR", "价格口径"),
            ColumnDefinition("open", "DOUBLE", "开盘点位", allow_null=True),
            ColumnDefinition("high", "DOUBLE", "最高点位", allow_null=True),
            ColumnDefinition("low", "DOUBLE", "最低点位", allow_null=True),
            ColumnDefinition("close", "DOUBLE", "收盘点位", allow_null=True),
            ColumnDefinition("pre_close", "DOUBLE", "前收点位", allow_null=True),
            ColumnDefinition("change_pct", "DOUBLE", "涨跌幅百分比", allow_null=True),
            ColumnDefinition("volume", "DOUBLE", "成交量", allow_null=True),
            ColumnDefinition("amount", "DOUBLE", "成交额", allow_null=True),
            ColumnDefinition("updated_at", "TIMESTAMP", "写入更新时间"),
        ),
        primary_key=("snapshot_id", "index_symbol", "trade_date", "price_basis"),
    ),
    TableDefinition(
        group="Derived Data",
    ...
    TableDefinition(
        ...
        description="持久化回测请求，作为 durable request 与 queue 状态的最小载体。",
        columns=(
            ...
            ColumnDefinition(
                ...
                "VARCHAR",
                "请求类型",
                default_sql="'backtest'",
            ),
            ColumnDefinition("requested_at", "TIMESTAMP", "请求创建时间"),
            ColumnDefinition("requested_by", "VARCHAR", "请求来源", allow_null=True),
            ColumnDefinition("snapshot_id", "VARCHAR", "发布快照标识"),
            ColumnDefinition("raw_snapshot_id", "VARCHAR", "原始快照标识"),
            ColumnDefinition("strategy_version", "VARCHAR", "策略版本"),
            ColumnDefinition("signal_price_basis", "VARCHAR", "信号价格口径"),
            ...
            ColumnDefinition("queue_state", "VARCHAR", "文件队列状态", allow_null=True),
            ColumnDefinition("retry_count", "INTEGER", "重试次数"),
            ColumnDefinition("max_retries", "INTEGER", "最大重试次数", default_sql="0"),
            ColumnDefinition(
                "next_attempt_at",
                "TIMESTAMP",
                "下一次可尝试时间",
            ...
            ColumnDefinition("started_at", "TIMESTAMP", "开始处理时间", allow_null=True),
            ColumnDefinition("finished_at", "TIMESTAMP", "结束处理时间", allow_null=True),
            ColumnDefinition("updated_at", "TIMESTAMP", "最近状态更新时间", allow_null=True),
    ...
    TableDefinition(
        group="Runs And Outputs",
        name="task_request",
        description="服务任务 durable request 表，补足文件队列之外的任务请求状态审计。",
        columns=(
            ColumnDefinition("request_id", "VARCHAR", "任务请求标识"),
            ColumnDefinition("request_type", "VARCHAR", "请求类型"),
            ColumnDefinition("task_name", "VARCHAR", "任务名称"),
            ColumnDefinition("requested_at", "TIMESTAMP", "请求创建时间"),
            ColumnDefinition("requested_by", "VARCHAR", "请求来源", allow_null=True),
            ColumnDefinition("biz_date", "DATE", "业务日期", allow_null=True),
            ColumnDefinition("snapshot_id", "VARCHAR", "关联发布快照", allow_null=True),
            ColumnDefinition("raw_snapshot_id", "VARCHAR", "关联原始快照", allow_null=True),
            ColumnDefinition("status", "VARCHAR", "请求状态"),
            ColumnDefinition("queue_state", "VARCHAR", "文件队列状态", allow_null=True),
            ColumnDefinition("priority", "INTEGER", "队列优先级", default_sql="0"),
            ColumnDefinition("attempt_no", "INTEGER", "当前尝试次数", default_sql="0"),
            ColumnDefinition("max_retries", "INTEGER", "最大重试次数", default_sql="0"),
            ColumnDefinition(
                "next_attempt_at",
                "TIMESTAMP",
            ...
            ColumnDefinition("created_at", "TIMESTAMP", "记录创建时间"),
            ColumnDefinition("updated_at", "TIMESTAMP", "最近状态更新时间"),
        ),
    ...
    TableDefinition(
        group="Runs And Outputs",
        name="task_run_log",
        description="任务运行日志，供页面展示运行状态与最近执行时间。",
        columns=(
            ColumnDefinition("task_id", "VARCHAR", "任务运行标识"),
            ColumnDefinition("request_id", "VARCHAR", "关联任务请求", allow_null=True),
            ColumnDefinition("raw_snapshot_id", "VARCHAR", "关联原始快照", allow_null=True),
            ColumnDefinition("task_name", "VARCHAR", "任务名称"),
            ColumnDefinition("biz_date", "DATE", "业务日期"),
    ...
    TableDefinition(
        ...
        description="任务与请求状态事件流水，用于追踪 PENDING/RUNNING/RETRY/SUCCESS/FAILED 的状态传播。",
        columns=(
            ColumnDefinition("event_id", "VARCHAR", "状态事件标识"),
            ColumnDefinition("request_id", "VARCHAR", "关联请求标识", allow_null=True),
            ColumnDefinition("task_id", "VARCHAR", "关联任务运行标识", allow_null=True),
            ColumnDefinition("event_type", "VARCHAR", "事件类型"),
            ColumnDefinition("from_status", "VARCHAR", "原状态", allow_null=True),
            ColumnDefinition("to_status", "VARCHAR", "新状态"),
            ColumnDefinition("attempt_no", "INTEGER", "尝试次数", default_sql="0"),
            ColumnDefinition("occurred_at", "TIMESTAMP", "事件发生时间"),
            ColumnDefinition("detail_json", "VARCHAR", "事件详情 JSON", allow_null=True),
        ),
