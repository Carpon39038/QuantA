...
TABLE_DEFINITIONS: tuple[TableDefinition, ...] = (
    ...
    TableDefinition(
        group="Derived Data",
        name="official_disclosure_item",
        description="官方披露事件 sidecar，供个股页和公告读口读取正文摘要、分类解释与问询状态。",
        columns=(
            ColumnDefinition("symbol", "VARCHAR", "证券代码"),
            ColumnDefinition("trade_date", "DATE", "公告日期"),
            ColumnDefinition("snapshot_id", "VARCHAR", "发布快照标识"),
            ColumnDefinition("announcement_id", "VARCHAR", "公告标识"),
            ColumnDefinition("disclosure_event_id", "VARCHAR", "去重后的披露事件标识"),
            ColumnDefinition("disclosure_event_type", "VARCHAR", "披露事件类型"),
            ColumnDefinition("org_id", "VARCHAR", "巨潮机构标识"),
            ColumnDefinition("title", "VARCHAR", "公告标题"),
            ColumnDefinition("short_title", "VARCHAR", "公告简称", allow_null=True),
            ColumnDefinition("announcement_time", "TIMESTAMP", "公告时间", allow_null=True),
            ColumnDefinition(
                "announcement_type",
                "VARCHAR",
                "公告类型编码",
            ...
            ColumnDefinition("body_summary", "VARCHAR", "公告正文摘要", allow_null=True),
            ColumnDefinition("inquiry_status", "VARCHAR", "问询函状态", allow_null=True),
            ColumnDefinition("reply_status", "VARCHAR", "回复函状态", allow_null=True),
            ColumnDefinition(
            ...
            ColumnDefinition("page_column", "VARCHAR", "页面栏目编码", allow_null=True),
            ColumnDefinition("adjunct_type", "VARCHAR", "附件类型", allow_null=True),
            ColumnDefinition("pdf_url", "VARCHAR", "官方 PDF 链接", allow_null=True),
            ColumnDefinition("detail_url", "VARCHAR", "官方详情链接", allow_null=True),
            ColumnDefinition("source", "VARCHAR", "来源说明"),
            ColumnDefinition("updated_at", "TIMESTAMP", "写入更新时间"),
        ),
        primary_key=("snapshot_id", "symbol", "announcement_id"),
    ),
    TableDefinition(
        group="Derived Data",
        name="corporate_action_item",
        description="企业行为 sidecar，供个股页解释分红送配和除权除息事件。",
        columns=(
            ColumnDefinition("symbol", "VARCHAR", "证券代码"),
            ColumnDefinition("trade_date", "DATE", "事件日期"),
            ColumnDefinition("snapshot_id", "VARCHAR", "发布快照标识"),
            ColumnDefinition("action_id", "VARCHAR", "企业行为标识"),
            ColumnDefinition("report_period", "DATE", "方案对应报告期", allow_null=True),
            ColumnDefinition("knowledge_date", "DATE", "系统已知日期", allow_null=True),
            ColumnDefinition("ann_date", "DATE", "董事会/股东大会公告日期", allow_null=True),
            ColumnDefinition("imp_ann_date", "DATE", "实施公告日期", allow_null=True),
            ColumnDefinition("record_date", "DATE", "股权登记日", allow_null=True),
            ColumnDefinition("ex_date", "DATE", "除权除息日", allow_null=True),
            ColumnDefinition("pay_date", "DATE", "派息日", allow_null=True),
            ColumnDefinition("div_listdate", "DATE", "红股上市日", allow_null=True),
            ColumnDefinition("stock_div", "DOUBLE", "每10股送转股数", allow_null=True),
            ColumnDefinition("cash_div_tax", "DOUBLE", "每10股含税派现", allow_null=True),
            ColumnDefinition("action_stage", "VARCHAR", "公告阶段", allow_null=True),
            ColumnDefinition("action_summary", "VARCHAR", "动作摘要", allow_null=True),
            ColumnDefinition("source", "VARCHAR", "来源说明"),
            ColumnDefinition("updated_at", "TIMESTAMP", "写入更新时间"),
        ),
        primary_key=("snapshot_id", "symbol", "action_id"),
    ),
    TableDefinition(
        group="Derived Data",
