    ...
    *,
    ...
    normalized_rows = [
        [
            ...
            str(row.get("disclosure_event_id") or row["announcement_id"]),
            str(row.get("disclosure_event_type") or "DISCLOSURE"),
            str(row["org_id"]),
            str(row["title"]),
            row.get("short_title"),
            ...
            row.get("classification_explanation"),
            row.get("body_summary"),
            row.get("inquiry_status"),
            row.get("reply_status"),
            row.get("related_announcement_id"),
            row.get("page_column"),
